...
const seo = {
    title: 'Seminar App',
    description: 'Seminar / Webinar App Dengan ReactJS dan CodeIgniter 3',
    image: '',
    url: '',
  }
...
class Detail extends Component {
    ...
    render() {
        return (
            <>
           <Helmet>
            <title>{this.state.nama} - { seo.title }</title>
            <meta name="description" content={this.state.headline+seo.description} />
            </Helmet>
                <Container>
