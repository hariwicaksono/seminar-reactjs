...
import FormSelect from '../Components/RegisterSelect';
...
class Wizard extends Component {
    ...
    render() {
        ...
        return (
            <>
            <Helmet>
            <title data-react-helmet="true">Register - { seo.title }</title>
            <meta data-react-helmet="true" name="description" content={'Register'+seo.description} />
            </Helmet>
                <Container>
                    <Row>
