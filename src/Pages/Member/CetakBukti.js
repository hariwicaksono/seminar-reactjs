...
class CetakBukti extends Component {
    ...
    render() {
        ...
        return (
            <>
           <Helmet>
           <title data-react-helmet="true">Cetak Bukti Daftar - { seo.title }</title>
            <meta data-react-helmet="true" name="description" content={'Cetak Bukti Daftar'+seo.description} />
            </Helmet>
                <Container>
